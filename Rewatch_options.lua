...
function rewatch_CreateOptions()
	...
	-- create the options frame with BackdropTemplate for MoP Classic compatibility
	rewatch_options = CreateFrame("FRAME", "Rewatch_Options", UIParent, "BackdropTemplate"); rewatch_options.name = "Rewatch";
	rewatch_options2 = CreateFrame("FRAME", "Rewatch_Options2", UIParent, "BackdropTemplate"); rewatch_options2.name = "Advanced"; rewatch_options2.parent = "Rewatch";
	rewatch_options3 = CreateFrame("FRAME", "Rewatch_Options3", UIParent, "BackdropTemplate"); rewatch_options3.name = "Highlighting"; rewatch_options3.parent = "Rewatch";
	rewatch_options4 = CreateFrame("FRAME", "Rewatch_Options4", UIParent, "BackdropTemplate"); rewatch_options4.name = "Macros"; rewatch_options4.parent = "Rewatch";
	-- slider
	...
	local healthCP = CreateFrame("BUTTON", "Rewatch_HealthCP", rewatch_options, "BackdropTemplate"); healthCP:SetWidth(18); healthCP:SetHeight(18);
	...
	local healthCPR = CreateFrame("BUTTON", "Rewatch_HealthCPR", rewatch_options, "UIPanelButtonTemplate"); healthCPR:SetText(rewatch_loc["reset"]);
	...
	local frameCP = CreateFrame("BUTTON", "Rewatch_FrameCP", rewatch_options, "BackdropTemplate"); frameCP:SetWidth(18); frameCP:SetHeight(18);
	...
	local frameCPR = CreateFrame("BUTTON", "Rewatch_FrameCPR", rewatch_options, "UIPanelButtonTemplate"); frameCPR:SetText(rewatch_loc["reset"]);
	...
	-- frame mark color
	local mframeCP = CreateFrame("BUTTON", "Rewatch_MFrameCP", rewatch_options, "BackdropTemplate"); mframeCP:SetWidth(18); mframeCP:SetHeight(18);
	...
	--[[lb stack colors]]--
	local barCP_lb = CreateFrame("BUTTON", "Rewatch_BarCP"..rewatch_loc["lifebloom"], rewatch_options, "BackdropTemplate"); barCP_lb:SetWidth(18); barCP_lb:SetHeight(18);
	...
	local barCP_lb2 = CreateFrame("BUTTON", "Rewatch_BarCP"..rewatch_loc["lifebloom"].."2", rewatch_options, "BackdropTemplate"); barCP_lb2:SetWidth(18); barCP_lb2:SetHeight(18);
	...
	local barCP_lb3 = CreateFrame("BUTTON", "Rewatch_BarCP"..rewatch_loc["lifebloom"].."3", rewatch_options, "BackdropTemplate"); barCP_lb3:SetWidth(18); barCP_lb3:SetHeight(18);
	...
	--[[/lb stack colors]]--
	local barCP_rej = CreateFrame("BUTTON", "Rewatch_BarCP"..rewatch_loc["rejuvenation"], rewatch_options, "BackdropTemplate"); barCP_rej:SetWidth(18); barCP_rej:SetHeight(18);
	...
	local barCP_reg = CreateFrame("BUTTON", "Rewatch_BarCP"..rewatch_loc["regrowth"], rewatch_options, "BackdropTemplate"); barCP_reg:SetWidth(18); barCP_reg:SetHeight(18);
	...
	local barCP_wg = CreateFrame("BUTTON", "Rewatch_BarCP"..rewatch_loc["wildgrowth"], rewatch_options, "BackdropTemplate"); barCP_wg:SetWidth(18); barCP_wg:SetHeight(18);
	...
	-- reset buttons
	local barCPR_lb = CreateFrame("BUTTON", "Rewatch_BarCPR", rewatch_options, "UIPanelButtonTemplate"); barCPR_lb:SetText(rewatch_loc["reset"]);
	...
	local barCPR_rej = CreateFrame("BUTTON", "Rewatch_BarCPR", rewatch_options, "UIPanelButtonTemplate"); barCPR_rej:SetText(rewatch_loc["reset"]);
	...
	local barCPR_reg = CreateFrame("BUTTON", "Rewatch_BarCPR", rewatch_options, "UIPanelButtonTemplate"); barCPR_reg:SetText(rewatch_loc["reset"]);
	...
	local barCPR_wg = CreateFrame("BUTTON", "Rewatch_BarCPR", rewatch_options, "UIPanelButtonTemplate"); barCPR_wg:SetText(rewatch_loc["reset"]);
	...
	local hideCB = CreateFrame("CHECKBUTTON", "Rewatch_HideCB", rewatch_options, "UICheckButtonTemplate");
	...
	local hideButtonsCB = CreateFrame("CHECKBUTTON", "Rewatch_HideButtonsCB", rewatch_options, "UICheckButtonTemplate");
	...
	local autoGroupCB = CreateFrame("CHECKBUTTON", "Rewatch_AutoGroupCB", rewatch_options, "UICheckButtonTemplate");
	...
	local lockCB = CreateFrame("CHECKBUTTON", "Rewatch_LockCB", rewatch_options, "UICheckButtonTemplate");
	...
	local labelsCB = CreateFrame("CHECKBUTTON", "Rewatch_LabelsCB", rewatch_options, "UICheckButtonTemplate");
	...
	local lockPCB = CreateFrame("CHECKBUTTON", "Rewatch_LockPCB", rewatch_options, "UICheckButtonTemplate");
	...
	local wgCB = CreateFrame("CHECKBUTTON", "Rewatch_WGCB", rewatch_options, "UICheckButtonTemplate");
	...
	local soloHideCB = CreateFrame("CHECKBUTTON", "Rewatch_SoloHideCB", rewatch_options, "UICheckButtonTemplate");
	...
	local ttCB = CreateFrame("CHECKBUTTON", "Rewatch_TTCB", rewatch_options, "UICheckButtonTemplate");
	...
	local bar = CreateFrame("EDITBOX", "Rewatch_BarTexture", rewatch_options, "BackdropTemplate");
	...
	local fontType = CreateFrame("EDITBOX", "Rewatch_FontType", rewatch_options, "BackdropTemplate");
	...
	local fontSize = CreateFrame("EDITBOX", "Rewatch_FontSize", rewatch_options, "BackdropTemplate");
	...
	local highlightSize = CreateFrame("EDITBOX", "Rewatch_HighlightSize", rewatch_options, "BackdropTemplate");
	...
	local layoutDefault = CreateFrame("CHECKBUTTON", "Rewatch_LDEFCB", rewatch_options2, "UICheckButtonTemplate");
	...
	local layoutVertical = CreateFrame("CHECKBUTTON", "Rewatch_LVERTCB", rewatch_options2, "UICheckButtonTemplate");
	...
	local showIncomingHeals = CreateFrame("CHECKBUTTON", "Rewatch_SIHCB", rewatch_options2, "UICheckButtonTemplate");
	...
	local sortByRole = CreateFrame("CHECKBUTTON", "Rewatch_SBRCB", rewatch_options2, "UICheckButtonTemplate");
	...
	local showSelfFirst = CreateFrame("CHECKBUTTON", "Rewatch_SSFCB", rewatch_options2, "UICheckButtonTemplate");
	...
	local hd = CreateFrame("CHECKBUTTON", "Rewatch_HDCB", rewatch_options2, "UICheckButtonTemplate");
	...
	local applyBTN = CreateFrame("BUTTON", "Rewatch_ApplyBTN", rewatch_options2, "UIPanelButtonTemplate"); applyBTN:SetText("Apply");
	...
	-- buttons
	local sortBTN = CreateFrame("BUTTON", "Rewatch_BuffCheckBTN", rewatch_options, "UIPanelButtonTemplate"); sortBTN:SetText(rewatch_loc["sortList"]);
	...
	local clearBTN = CreateFrame("BUTTON", "Rewatch_BuffCheckBTN", rewatch_options, "UIPanelButtonTemplate"); clearBTN:SetText(rewatch_loc["clearList"]);
	...
	local reposBTN = CreateFrame("BUTTON", "Rewatch_RepositionBTN", rewatch_options, "UIPanelButtonTemplate"); reposBTN:SetText(rewatch_loc["reposition"]);
	...
	local ch = CreateFrame("EDITBOX", "Rewatch_Highlighting", rewatch_options3, "BackdropTemplate");
	...
	local ch2 = CreateFrame("EDITBOX", "Rewatch_Highlighting2", rewatch_options3, "BackdropTemplate");
	...
	local ch3 = CreateFrame("EDITBOX", "Rewatch_Highlighting3", rewatch_options3, "BackdropTemplate");
	...
	local alt = CreateFrame("EDITBOX", "Rewatch_AltMacro", rewatch_options4, "BackdropTemplate");
	...
	local ctrl = CreateFrame("EDITBOX", "Rewatch_CtrlMacro", rewatch_options4, "BackdropTemplate");
	...
	local shift = CreateFrame("EDITBOX", "Rewatch_ShiftMacro", rewatch_options4, "BackdropTemplate");
	...
	-- add panels (safe wrapper for MoP Classic compatibility)
	-- Only register if InterfaceOptions_AddCategory exists
	-- Panels will still work via InterfaceOptionsFrame_OpenToCategory which is used by /rewatch options
	if(InterfaceOptions_AddCategory) then
		...
		-- In MoP Classic, InterfaceOptions_AddCategory may not exist
		-- Panels are still accessible via /rewatch options command which uses InterfaceOptionsFrame_OpenToCategory
		-- Try to register when Blizzard_InterfaceOptions loads
		local hookFrame = CreateFrame("Frame");
		hookFrame:RegisterEvent("ADDON_LOADED");
		hookFrame:SetScript("OnEvent", function(self, event, addonName)
			if(addonName == "Blizzard_InterfaceOptions" and InterfaceOptions_AddCategory) then
				InterfaceOptions_AddCategory(rewatch_options);
				InterfaceOptions_AddCategory(rewatch_options2);
				InterfaceOptions_AddCategory(rewatch_options3);
				InterfaceOptions_AddCategory(rewatch_options4);
...
function rewatch_OptionsFromData(get)
	...
	for _, child in ipairs(children) do
		...
		elseif(child:GetName() == "Rewatch_NBW") then
			...
			if(get) then child:SetValue(1); getglobal("Rewatch_NBWText"):SetText("1"); 
			else rewatch_load["NumFramesWide"], rewatch_loadInt["NumFramesWide"] = 1, 1; end;
